...
public class PlayerInputCheck : NetworkBehaviour
{
    ...
    //public void OnWeaponUpgrade(InputAction.CallbackContext con)
    //{
    //    if (!con.started) return;
    //    WeaponUpgradeCheck();
    //    Debug.Log("무기 업그레이드");
    ...
    //{
    //    WeaponUpgradeOpen = !WeaponUpgradeOpen;
    //    if (WeaponUpgradeOpen)
    //    {
    //        upgradeWeapon.UpgradeWeaponOPEN();            
    //    }
    //    else
    //    {
    //        upgradeWeapon.ExitUpgradeWeapon();
    //    }
    //}
